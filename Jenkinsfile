pipeline {
    agent any
    environment {
        TF_VAR_gcp_project = "qwiklabs-gcp-03-acd3d49b5816"
        TF_VAR_bucket = "tf-remote-state-student_03_c7e27b4e4d6b-10711-18220"
        REPOSITORY = "https://github.com/twistedinferno/sample-awx-project.git"
